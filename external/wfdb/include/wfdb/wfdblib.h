...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/aditya-chauhdry/Desktop/Projects/signal_processing/qrs-detector-et-pd-c/external/wfdb/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/aditya-chauhdry/Desktop/Projects/signal_processing/qrs-detector-et-pd-c/external/wfdb/database).
...
# define DEFWFDB	". /home/aditya-chauhdry/Desktop/Projects/signal_processing/qrs-detector-et-pd-c/external/wfdb/database"
#else
# define DEFWFDB ". /home/aditya-chauhdry/Desktop/Projects/signal_processing/qrs-detector-et-pd-c/external/wfdb/database http://physionet.org/physiobank/database"
#endif
